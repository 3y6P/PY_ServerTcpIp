...
class RegexClass(object):
    ...
    def ClientNameGet(self, strokeEnter):
        pattern0 = ']'
        patStroke = (re.split(pattern0, strokeEnter))
        for i in range(len(patStroke)):
            print(patStroke[i].replace("[",""))


if __name__ == "__main__":
    RgCls = RegexClass
    RgCls.ClientNameGet(RgCls, "[asdasd][123345][asd3342SS]")